...
#include "error_codes.h"
	...
	extern int32_t HEADER_NOTIFICAR_IO = 1004;
	extern int32_t HEADER_NOTIFICAR_FIN_QUANTUM = 1005;
	extern int32_t HEADER_NOTIFICAR_FIN_RAFAGA = 1006;
	extern int32_t HEADER_NOTIFICAR_WAIT = 1007;
